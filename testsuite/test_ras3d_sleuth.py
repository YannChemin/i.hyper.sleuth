"""Tests that libras3d is functional for i.hyper.sleuth standalone mode."""
import os, sys
import numpy as np
import pytest
...
def test_wavelength_sidecar():
    ...
    ras3d.close_cube(h)
    sys.path.insert(0, '/home/yann/dev/i.hyper.sleuth')
    import importlib
    m = importlib.import_module('i_hyper_sleuth')
    try:
